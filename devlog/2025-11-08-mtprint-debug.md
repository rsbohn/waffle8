...
- Confirmed that the remote emulator is now executing the updated mtprint binary, matching the current source and listing. Documented steps in this entry for future debugging.
